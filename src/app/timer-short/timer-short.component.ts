...
@Component({
  selector: 'app-timer-short',
  templateUrl: './timer-short.component.html',
  styleUrls: ['./timer-short.component.scss']
})
export class TimerShortComponent implements OnInit {
  ...
  onShort() {
    ...
    this.disabled = true;
    setTimeout(() => {
      this.appService.setShortBreak(false);
